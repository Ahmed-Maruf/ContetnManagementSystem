...
('{$the_post_id}', '{$comment_author}', '{$comment_email}', '{$comment_content}', 'unapproved', now())";
				...
				$comment_connection = mysqli_query($connection, $query);

				if(!$comment_connection){
					die("QUERY FAILED" . mysqli_error($connection));
				}

			}
			else{
				echo "You must comment something!!!";
			}
			...
			<div class="well">
				...
				<form action="" method="post" role="form">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="comment_author" placeholder="comment_author">
					</div>

					<div class="form-group">
						<label for="Email">Email</label>
						<input type="email" class="form-control" name="comment_email" placeholder="comment_email">
					</div>
